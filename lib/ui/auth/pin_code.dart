...
class _MyHomePageState extends State<PinCode> with TickerProviderStateMixin {
  ...
  Widget pinCode( PinCodeModle auth) {
    return SafeArea(
      child: Container(
  ...
  Widget build(BuildContext context) {
    return BaseWidget<PinCodeModle>(
        model: getIt<PinCodeModle>(),
        builder: (BuildContext context, PinCodeModle modle, Widget child) =>
            Scaffold(
                key: _scaffoldkey,
                appBar: AppBar(),
                    ...
                    child: ListView(children: <Widget>[
                      ...
                      Container(
                        ...
                        child: ListTile(
                          title: Row(
                            ...
                            children: <Widget>[
                              Text(trans(
                                  context, 'change_phone_while_regestrating')),
                            ],
                          ),
                          onTap: () {
                            if (!modle.busy) {
                              final FocusNode focus1 = FocusNode();
                              final bool isRTL = Directionality.of(context) ==
                                  TextDirection.rtl;
                                ...
                                (BuildContext context) {
                                  ...
                                  return Container(
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        Text(
                                            trans(context, 'enter_new_mobile')),
                              ...
                              showToast(
                                  trans(context, 'you_can_change_mo_only_once'),
                                  context: context,
                      ...
                      Padding(
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () {},
                              child: modle.returnchildforPinCode(
