...
class _MyResetPasswordState extends State<ResetPassword>
  ...
  Widget customcard(BuildContext context, ResetPasswordModle modle) {
    return Padding(
            ...
            children: <Widget>[
              TextFormInput(
                  ...
                  validator: (String value) {
                    ...
                    return modle.resetPassValidationMap['password'];
                  }),
              TextFormInput(
                  text: trans(context, 'new_password'),
  ...
  Widget build(BuildContext context) {
    return BaseWidget<ResetPasswordModle>(
        model: getIt<ResetPasswordModle>(),
        builder: (BuildContext context, ResetPasswordModle modle,
                Widget child) =>
            Scaffold(
                appBar: AppBar(),
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                              ...
                              child: modle.returnchildResetPass(
                                  trans(context, 'restore'))),
                        ),
                      ],
                    ),
                  ]),
  ...
  Future<void> doOnPress(
    ResetPasswordModle modle,
  ) async {
    if (newpasswordController.text.trim() !=
      ...
      if (_formKey.currentState.validate()) {
        ...
        if (await modle.resetpassword(phone, newpasswordController.text)) {
          AwesomeDialog(
              context: context,
              ...
              desc: trans(context, 'password_has_changed_successfully'),
              btnOkOnPress: () {
        ...
        modle.resetPassValidationMap.updateAll((String key, String value) {
          return null;
        });
      }
    }
