class FilterData{
  FilterData(this.merchantNameOrPartOfit, this.saleNameOrPartOfit, this.startingdate, this.endingdate,  this.rating, this.specifications, this.fromPrice, this.toPrice);
